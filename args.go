...
type Args struct {
	...
	SkipSymbol []string `arg:"--ss" help:"ignore lines with specific prefix(support for multiple arguments)"`
	SkipNum    int      `arg:"--sn" help:"ignore first n lines [default: 0]"`
	ShowNum    []int    `arg:"--rc" help:"only retain and show these column, separated by space"`
	HideNum    []int    `arg:"--hc" help:"hide these column, separated by space"`
